        ...
        if ($fluida_meta_category && get_the_category_list())
        {
            echo '<div class="entry-meta">
				<span class="bl_categ"' . cryout_schema_microdata('category', 0) . '>
					<i class="icon-folder-open icon-metas" title="' . __("Categories", "fluida") . '"></i>' . get_the_category_list(', ') . '</span>
			  </div>';
        }
...
if (!function_exists('fluida_posted_author')):
    function fluida_posted_author()
    {
        ...
        {
            echo sprintf('<span class="author vcard"' . cryout_schema_microdata('author', 0) . '>
				<em>' . __('By', 'fluida') . '</em>
			...
			</span>', esc_url(get_author_posts_url(get_the_author_meta('ID'))) , sprintf(esc_attr__('View all posts by %s', 'fluida') , get_the_author()) , get_the_author());
        }
...
function fluida_meta_format()
{
    ...
    {
        printf('<span class="entry-format"><a href="%1$s"><i class="icon-%2$s" title="%3$s"></i></a></span>', esc_url(get_post_format_link($format)) , $format, get_post_format_string($format));
    }
       ...
       <?php if (is_mobile())
            {
                if (has_tag("2021"))
                {
                    echo '<i class="destroy" aria-hidden="true" style="padding:2.5px 2.5px;position:absolute;right:2%;top:66%;font-size:17px;">2021</i>';
                }
                if (has_tag("2022"))
                {
                    echo '<i class="destroy" aria-hidden="true" style="padding:2.5px 2.5px;position:absolute;right:2%;top:66%;font-size:17px;">2022</i>';
                }
                if (has_tag("exclusive"))
                {
                    echo '<a href="/tags/uncensored-hentai" target="_blank"><i class="fa fa-bolt" aria-hidden="true" style="padding:2.5px 7px;position:absolute;left:2.5%;top:68%;background:red;border-radius:4px;"></i></a>';
                }
                if (has_tag("uncensored-hentai") && has_tag("1080p"))
                {
                    echo '<a href="/tags/uncensored-hentai" target="_blank"><i class="fa fa-eye" aria-hidden="true" style="padding:2.5px 2.5px;position:absolute;right:2.5%;bottom:88%;background:red;border-radius:4px;"></i></a><a href="/tags/1080p" target="_blank"><i class="destroy" aria-hidden="true" style="padding:2.5px;position:absolute;left:2.5%;bottom:87%;color:#fff;background:red;border-radius:4px;font-size:11px;">HD+</i></a>';
                }
                elseif (has_tag("uncensored-hentai"))
                {
                    echo '<a href="/tags/uncensored-hentai" target="_blank"><i class="fa fa-eye" aria-hidden="true" style="padding:2px;position:absolute;right:2.5%;bottom:90%;background:red;border-radius:4px;"></i></a>';
                }
                else
                {
                    if (has_tag("1080p"))
                    {
                        echo '<a href="/tags/1080p" target="_blank"><i class="destroy" aria-hidden="true" style="padding:1px;position:absolute;left:2.5%;bottom:90%;color:#fff;background:red;border-radius:4px;font-size:11px;">HD+<br></i></a>';
                    }
                }
            }
            if (!is_mobile())
            {
                if (has_tag("2021"))
                {
                    echo '<a href="/tags/2021/" target="_blank"><i class="destroy" aria-hidden="true" style="padding:2.5px 2.5px;position:absolute;right:2%;top:65%;font-size:17px;">2021</i></a>';
                }
                if (has_tag("2022"))
                {
                    echo '<a href="/tags/2022/" target="_blank"><i class="destroy" aria-hidden="true" style="padding:2.5px 2.5px;position:absolute;right:2%;top:65%;font-size:17px;">2022</i></a>';
                }
                if (has_tag("exclusive"))
                {
                    echo '<a href="/tags/uncensored-hentai" target="_blank"><i class="fa fa-bolt" aria-hidden="true" style="padding:2.5px 7px;position:absolute;left:2.5%;top:65%;background:red;border-radius:4px;"></i></a>';
                }
                if (has_tag("uncensored-hentai") && has_tag("1080p"))
                {
                    echo '<a href="/tags/uncensored-hentai" target="_blank"><i class="fa fa-eye" aria-hidden="true" style="padding:2.5px 2.5px;position:absolute;right:2.5%;bottom:87%;background:red;border-radius:4px;"></i></a><a href="/tags/1080p" target="_blank"><i class="destroy" aria-hidden="true" style="padding:2.5px;position:absolute;left:2.4%;bottom:87%;;color:#fff;background:red;border-radius:4px;font-size:12px;">HD+</i></a>';
                }
                elseif (has_tag("uncensored-hentai"))
                {
                    echo '<a href="/tags/uncensored-hentai" target="_blank"><i class="fa fa-eye" aria-hidden="true" style="padding:2px;position:absolute;right:2.5%;bottom:87%;background:red;border-radius:4px;"></i></a>';
                }
                else
                {
                    if (has_tag("1080p"))
                    {
                        echo '<a href="/tags/1080p" target="_blank"><i class="destroy" aria-hidden="true" style="padding:2px;position:absolute;left:2.5%;bottom:87%;color:#fff;background:red;border-radius:4px;font-size:12px;">HD+</i></a>';
                    }
                }
            } ?>
        <!--<span class="video" data-video="<?php $a = "https://hfdl.site/fucked.php?postID=" . $post->ID;
            echo $a; ?>"></span>-->
        </a></div>
