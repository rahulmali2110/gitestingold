...
#site-header-main, #site-header-main,  #site-header-main-inside, #access ul li, #access ul ul,
...
pre, .entry-meta .author, nav.sidebarmenu, .page-link > span, article #author-info, #footer, .comment-author,
...
#mobile-menu a.mopen 						{ border-color: <?php echo esc_html( $fluida_sitetext ) ?>;
...
.fluida-clean-table .main th, .fluida-clean-table .main td,
.fluida-stripped-table .main th, .fluida-stripped-table .main td,
...
/////////// HEADER LAYOUT ///////////
?>
#site-header-main, #site-header-main { height:<?php echo esc_html( $fluida_menuheight ) ?>px; }
